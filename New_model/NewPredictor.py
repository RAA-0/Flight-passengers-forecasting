...
class NewPredictor:
    ...
    def predict_changes(self):
        model=joblib.load("New_model\\models\\prophet_arrival_model.joblib")
    ...
    def new_prediction(self):
        ...
        df[['ds','event','total','Predicted_total','predicted_change','new_prediction']].to_csv('New_model\\data\\new_predictions.csv',index=False)
